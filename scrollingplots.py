...
win.nextRow()
p3 = win.addPlot(title='累积u', colspan=2)
curve3 = p3.plot()
...
def update2():
    ...
    #data1[:-1] = data1[1:]  # shift data in the array one sample left
                            # (see also: np.roll)
    curve3.setData(datau)

win.nextRow()
p4 = win.addPlot(title='累积v', colspan=2)
curve4 = p4.plot()
...
def update2():
    ...
    #print('data3', data3[:ptr3], len(data3[:ptr3]))
    #data.obtain_uv()
    #print('画图获取质心', get_value())
